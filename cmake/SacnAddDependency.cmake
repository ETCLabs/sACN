...
option(SACN_FORCE_SUBMODULE_DEPS "Disable overriding of submodule dependencies with clones at same level as sACN" OFF)

function(sacn_add_dependency target loc_variable)
  ...
  if(NOT TARGET ${target})
    ...
    elseif(NOT SACN_FORCE_SUBMODULE_DEPS AND EXISTS "${SACN_ROOT}/../${target}")

      message(STATUS "Found directory for ${target} at same level as sACN. Overriding submodule dependency with that directory.")
      add_subdirectory(${SACN_ROOT}/../${target} ${target})
