...
/**
 * @brief Whether or not to enable the rekey test.
 *
 * If enabled, sources and receivers will rekey at regular intervals, alternating between hardcoded keys. This assumes
 * two library instances for sending and receiving respectively, and that the receiving end is running before
 * transmission begins. This allows the rekey intervals to synchronize.
 *
 * If disabled, sources and receivers will be locked to a hardcoded key.
 */
#ifndef SACN_ENABLE_SRTP_REKEY_TEST
#define SACN_ENABLE_SRTP_REKEY_TEST 0
#endif
...
#define SACN_SRTP_CRYPTO_POLICY_STR "Default cipher & authentication" SACN_SRTP_CRYPTO_POLICY_STR_POSTFIX
#else
#define SACN_SRTP_CRYPTO_POLICY_DEFAULT 0
#endif

#ifdef SACN_SRTP_CRYPTO_POLICY_AES_CM_128_HMAC_SHA1_32
#define SACN_SRTP_CRYPTO_POLICY_STR "AES-CM-128 with HMAC-SHA1-32" SACN_SRTP_CRYPTO_POLICY_STR_POSTFIX
#else
#define SACN_SRTP_CRYPTO_POLICY_AES_CM_128_HMAC_SHA1_32 0
#endif

#ifdef SACN_SRTP_CRYPTO_POLICY_AES_CM_128_NULL_AUTH
#define SACN_SRTP_CRYPTO_POLICY_STR "AES-CM-128 with NULL authentication" SACN_SRTP_CRYPTO_POLICY_STR_POSTFIX
#else
#define SACN_SRTP_CRYPTO_POLICY_AES_CM_128_NULL_AUTH 0
#endif

#ifdef SACN_SRTP_CRYPTO_POLICY_NULL_CIPHER_HMAC_SHA1_80
#define SACN_SRTP_CRYPTO_POLICY_STR "NULL cipher with HMAC-SHA1-80" SACN_SRTP_CRYPTO_POLICY_STR_POSTFIX
#else
#define SACN_SRTP_CRYPTO_POLICY_NULL_CIPHER_HMAC_SHA1_80 0
#endif

#ifdef SACN_SRTP_CRYPTO_POLICY_NULL_CIPHER_HMAC_NULL
#define SACN_SRTP_CRYPTO_POLICY_STR "NULL cipher with NULL authentication" SACN_SRTP_CRYPTO_POLICY_STR_POSTFIX
#else
#define SACN_SRTP_CRYPTO_POLICY_NULL_CIPHER_HMAC_NULL 0
#endif

#ifdef SACN_SRTP_CRYPTO_POLICY_AES_CM_256_HMAC_SHA1_80
#define SACN_SRTP_CRYPTO_POLICY_STR "AES-CM-256 with HMAC-SHA1-80" SACN_SRTP_CRYPTO_POLICY_STR_POSTFIX
#else
#define SACN_SRTP_CRYPTO_POLICY_AES_CM_256_HMAC_SHA1_80 0
#endif

#ifdef SACN_SRTP_CRYPTO_POLICY_AES_CM_256_HMAC_SHA1_32
#define SACN_SRTP_CRYPTO_POLICY_STR "AES-CM-256 with HMAC-SHA1-32" SACN_SRTP_CRYPTO_POLICY_STR_POSTFIX
#else
#define SACN_SRTP_CRYPTO_POLICY_AES_CM_256_HMAC_SHA1_32 0
#endif

#ifdef SACN_SRTP_CRYPTO_POLICY_AES_CM_256_NULL_AUTH
#define SACN_SRTP_CRYPTO_POLICY_STR "AES-CM-256 with NULL authentication" SACN_SRTP_CRYPTO_POLICY_STR_POSTFIX
#else
#define SACN_SRTP_CRYPTO_POLICY_AES_CM_256_NULL_AUTH 0
#endif

#ifdef SACN_SRTP_CRYPTO_POLICY_AES_CM_192_HMAC_SHA1_80
#define SACN_SRTP_CRYPTO_POLICY_STR "AES-CM-192 with HMAC-SHA1-80" SACN_SRTP_CRYPTO_POLICY_STR_POSTFIX
#else
#define SACN_SRTP_CRYPTO_POLICY_AES_CM_192_HMAC_SHA1_80 0
#endif

#ifdef SACN_SRTP_CRYPTO_POLICY_AES_CM_192_HMAC_SHA1_32
#define SACN_SRTP_CRYPTO_POLICY_STR "AES-CM-192 with HMAC-SHA1-32" SACN_SRTP_CRYPTO_POLICY_STR_POSTFIX
#else
#define SACN_SRTP_CRYPTO_POLICY_AES_CM_192_HMAC_SHA1_32 0
#endif

#ifdef SACN_SRTP_CRYPTO_POLICY_AES_CM_192_NULL_AUTH
#define SACN_SRTP_CRYPTO_POLICY_STR "AES-CM-192 with NULL authentication" SACN_SRTP_CRYPTO_POLICY_STR_POSTFIX
#else
#define SACN_SRTP_CRYPTO_POLICY_AES_CM_192_NULL_AUTH 0
#endif

#ifdef SACN_SRTP_CRYPTO_POLICY_AES_GCM_128_16_AUTH
#define SACN_SRTP_CRYPTO_POLICY_STR "AES-GCM-128 with 16-byte authentication tag" SACN_SRTP_CRYPTO_POLICY_STR_POSTFIX
#else
#define SACN_SRTP_CRYPTO_POLICY_AES_GCM_128_16_AUTH 0
#endif

#ifdef SACN_SRTP_CRYPTO_POLICY_AES_GCM_256_16_AUTH
#define SACN_SRTP_CRYPTO_POLICY_STR "AES-GCM-256 with 16-byte authentication tag" SACN_SRTP_CRYPTO_POLICY_STR_POSTFIX
#else
#define SACN_SRTP_CRYPTO_POLICY_AES_GCM_256_16_AUTH 0
#endif
...
#if (SACN_DMX_MERGER_MAX_SLOTS < 1)
#error "Error: SACN_DMX_MERGER_MAX_SLOTS must be >= 1."
#endif
#else
