...
#define SACN_VERSION_BUILD 21 /**< The build number. */
/**
 * @}
 */
 ...
 * @{
 */
#define SACN_VERSION_STRING      "3.0.0.21" /**< The 4-digit version string. */
#define SACN_VERSION_DATESTR     "13.Jul.2023" /**< The date this version was released (dd.Mm.yyyy). */
