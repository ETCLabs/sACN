...
#define SACN_VERSION_BUILD 20 /**< The build number. */
/**
 * @}
 */
 ...
 * @{
 */
#define SACN_VERSION_STRING      "3.0.0.20" /**< The 4-digit version string. */
#define SACN_VERSION_DATESTR     "10.Jul.2023" /**< The date this version was released (dd.Mm.yyyy). */
