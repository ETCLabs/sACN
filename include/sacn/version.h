...
#define SACN_VERSION_BUILD 13 /**< The build number. */
/**
 * @}
 */
 ...
 * @{
 */
#define SACN_VERSION_STRING      "3.0.0.13" /**< The 4-digit version string. */
#define SACN_VERSION_DATESTR     "09.Mar.2023" /**< The date this version was released (dd.Mm.yyyy). */
