...
#define SACN_VERSION_BUILD 24 /**< The build number. */
/**
 * @}
 */
 ...
 * @{
 */
#define SACN_VERSION_STRING      "3.0.0.24" /**< The 4-digit version string. */
#define SACN_VERSION_DATESTR     "16.Nov.2023" /**< The date this version was released (dd.Mm.yyyy). */
