...
#define SACN_VERSION_BUILD 23 /**< The build number. */
/**
 * @}
 */
 ...
 * @{
 */
#define SACN_VERSION_STRING      "3.0.0.23" /**< The 4-digit version string. */
#define SACN_VERSION_DATESTR     "17.Oct.2023" /**< The date this version was released (dd.Mm.yyyy). */
