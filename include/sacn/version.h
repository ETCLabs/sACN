...
#define SACN_VERSION_BUILD 9 /**< The build number. */
/**
 * @}
 */
 ...
 * @{
 */
#define SACN_VERSION_STRING      "2.0.0.9" /**< The 4-digit version string. */
#define SACN_VERSION_DATESTR     "14.Sep.2021" /**< The date this version was released (dd.Mm.yyyy). */
