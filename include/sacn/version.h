...
#define SACN_VERSION_BUILD 10 /**< The build number. */
/**
 * @}
 */
 ...
 * @{
 */
#define SACN_VERSION_STRING      "3.0.0.10" /**< The 4-digit version string. */
#define SACN_VERSION_DATESTR     "07.Feb.2023" /**< The date this version was released (dd.Mm.yyyy). */
