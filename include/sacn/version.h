...
#define SACN_VERSION_BUILD 15 /**< The build number. */
/**
 * @}
 */
 ...
 * @{
 */
#define SACN_VERSION_STRING      "2.0.0.15" /**< The 4-digit version string. */
#define SACN_VERSION_DATESTR     "04.Jan.2022" /**< The date this version was released (dd.Mm.yyyy). */
