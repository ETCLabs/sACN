...
#define SACN_VERSION_BUILD 17 /**< The build number. */
/**
 * @}
 */
 ...
 * @{
 */
#define SACN_VERSION_STRING      "2.0.0.17" /**< The 4-digit version string. */
#define SACN_VERSION_DATESTR     "18.Jan.2022" /**< The date this version was released (dd.Mm.yyyy). */
