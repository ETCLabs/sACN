...
#define SACN_VERSION_BUILD 14 /**< The build number. */
/**
 * @}
 */
 ...
 * @{
 */
#define SACN_VERSION_STRING      "3.0.0.14" /**< The 4-digit version string. */
#define SACN_VERSION_DATESTR     "11.May.2023" /**< The date this version was released (dd.Mm.yyyy). */
