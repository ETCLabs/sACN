...
#define SACN_VERSION_BUILD 19 /**< The build number. */
/**
 * @}
 */
 ...
 * @{
 */
#define SACN_VERSION_STRING      "3.0.0.19" /**< The 4-digit version string. */
#define SACN_VERSION_DATESTR     "29.Jun.2023" /**< The date this version was released (dd.Mm.yyyy). */
