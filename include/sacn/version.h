...
#define SACN_VERSION_PATCH 2 /**< The patch version. */
 ...
 * @{
 */
#define SACN_VERSION_STRING      "2.0.2.3" /**< The 4-digit version string. */
#define SACN_VERSION_DATESTR     "17.Aug.2022" /**< The date this version was released (dd.Mm.yyyy). */
