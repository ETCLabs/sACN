...
#define SACN_VERSION_BUILD 3 /**< The build number. */
/**
 * @}
 */
 ...
 * @{
 */
#define SACN_VERSION_STRING      "4.0.0.3" /**< The 4-digit version string. */
#define SACN_VERSION_DATESTR     "13.Feb.2025" /**< The date this version was released (dd.Mm.yyyy). */
#define SACN_VERSION_COPYRIGHT   "Copyright 2025 ETC Inc." /**< The version's copyright string. */
