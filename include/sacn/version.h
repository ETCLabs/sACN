...
#define SACN_VERSION_BUILD 4 /**< The build number. */
/**
 * @}
 */
 ...
 * @{
 */
#define SACN_VERSION_STRING      "4.0.0.4" /**< The 4-digit version string. */
#define SACN_VERSION_DATESTR     "27.Jan.2026" /**< The date this version was released (dd.Mm.yyyy). */
#define SACN_VERSION_COPYRIGHT   "Copyright 2026 ETC Inc." /**< The version's copyright string. */
