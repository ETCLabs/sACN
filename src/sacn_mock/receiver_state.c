...
DEFINE_FAKE_VOID_FUNC(remove_receiver_from_thread, SacnReceiver*, socket_close_behavior_t);
DEFINE_FAKE_VOID_FUNC(remove_source_detector_from_thread, SacnSourceDetector*, socket_close_behavior_t);
