...
DECLARE_FAKE_VOID_FUNC(sacn_send_multicast, uint16_t, etcpal_iptype_t, const uint8_t*, const EtcPalMcastNetintId*,
                       size_t);
DECLARE_FAKE_VOID_FUNC(sacn_send_unicast, const uint8_t*, const EtcPalIpAddr*);
