...
DEFINE_FAKE_VOID_FUNC(increment_sequence_number, SacnSourceUniverse*, uint8_t*);
DEFINE_FAKE_VOID_FUNC(send_universe_unicast, const SacnSource*, SacnSourceUniverse*, const uint8_t*, bool*);
DEFINE_FAKE_VOID_FUNC(send_universe_multicast, const SacnSource*, SacnSourceUniverse*, const uint8_t*, bool*);
