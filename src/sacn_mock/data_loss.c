...
DEFINE_FAKE_VOID_FUNC(mark_sources_online, const SacnSourceInternal*, size_t, TerminationSet*);
DEFINE_FAKE_VOID_FUNC(mark_sources_offline, const SacnLostSourceInternal*, size_t, const SacnSourceInternal*, size_t,
