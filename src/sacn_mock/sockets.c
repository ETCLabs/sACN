...
DEFINE_FAKE_VALUE_FUNC(etcpal_error_t,
                       sacn_initialize_receiver_netints,
                       SacnInternalNetintArray*,
                       bool,
                       EtcPalRbTree*,
                       const SacnNetintConfig*);
DEFINE_FAKE_VALUE_FUNC(etcpal_error_t,
                       sacn_add_all_netints_to_sampling_period,
                       SacnInternalNetintArray*,
                       EtcPalRbTree*);
DEFINE_FAKE_VALUE_FUNC(etcpal_error_t,
                       sacn_initialize_source_detector_netints,
                       SacnInternalNetintArray*,
                       const SacnNetintConfig*);
DEFINE_FAKE_VALUE_FUNC(etcpal_error_t,
                       sacn_initialize_source_netints,
                       SacnInternalNetintArray*,
                       const SacnNetintConfig*);
DEFINE_FAKE_VOID_FUNC(sacn_get_mcast_addr, etcpal_iptype_t, uint16_t, EtcPalIpAddr*);
DEFINE_FAKE_VALUE_FUNC(etcpal_error_t,
                       sacn_add_receiver_socket,
                       sacn_thread_id_t,
                       etcpal_iptype_t,
                       uint16_t,
                       ...
                       size_t,
                       etcpal_socket_t*);
DEFINE_FAKE_VOID_FUNC(sacn_remove_receiver_socket,
                      sacn_thread_id_t,
                      etcpal_socket_t*,
                      uint16_t,
                      const EtcPalMcastNetintId*,
...
DEFINE_FAKE_VALUE_FUNC(etcpal_error_t, sacn_read_REMOVE_THIS, SacnRecvThreadContext*, SacnReadResult*);
DEFINE_FAKE_VALUE_FUNC(etcpal_error_t, sacn_read, SacnRecvThreadContext*);
DEFINE_FAKE_VALUE_FUNC(etcpal_error_t,
                       sacn_send_multicast,
                       uint16_t,
                       sacn_ip_support_t,
...
void sacn_sockets_reset_all_fakes(void)
{
  ...
  RESET_FAKE(sacn_read_REMOVE_THIS);
