...
#define SACN_RTP_HEADER_SIZE                12
#define SACN_DATA_HEADER_SIZE               (SACN_RTP_HEADER_SIZE + 126)
#define SACN_SYNC_PDU_SIZE                  (SACN_RTP_HEADER_SIZE + 49)
#define SACN_UNIVERSE_DISCOVERY_HEADER_SIZE (SACN_RTP_HEADER_SIZE + 120)
#define SACN_MAX_UNIVERSES_PER_PAGE         512

#define SACN_PRI_OFFSET        (SACN_RTP_HEADER_SIZE + 108)
#define SACN_SEQ_OFFSET        (SACN_RTP_HEADER_SIZE + 111)
#define SACN_OPTS_OFFSET       (SACN_RTP_HEADER_SIZE + 112)
#define SACN_START_CODE_OFFSET (SACN_RTP_HEADER_SIZE + 125)

#define SACN_ROOT_VECTOR_OFFSET                  (SACN_RTP_HEADER_SIZE + ACN_UDP_PREAMBLE_SIZE + 2)
#define SACN_FRAMING_OFFSET                      (SACN_RTP_HEADER_SIZE + 38)
#define SACN_FRAMING_VECTOR_OFFSET               (SACN_RTP_HEADER_SIZE + 40)
#define SACN_SOURCE_NAME_OFFSET                  (SACN_RTP_HEADER_SIZE + 44)
#define SACN_DMP_OFFSET                          (SACN_RTP_HEADER_SIZE + 115)
#define SACN_PROPERTY_VALUE_COUNT_OFFSET         (SACN_RTP_HEADER_SIZE + 123)
#define SACN_UNIVERSE_DISCOVERY_OFFSET           (SACN_RTP_HEADER_SIZE + 112)
...
#define SET_DATA_SLOT_COUNT(bufptr, slot_count)                                                                      \
  do                                                                                                                 \
  {                                                                                                                  \
    ACN_PDU_PACK_NORMAL_LEN(&bufptr[SACN_RTP_HEADER_SIZE + ACN_UDP_PREAMBLE_SIZE],                                   \
                            SACN_DATA_HEADER_SIZE + slot_count - ACN_UDP_PREAMBLE_SIZE - SACN_RTP_HEADER_SIZE);      \
...
#define SET_UNIVERSE_COUNT(bufptr, count)                                                                         \
  do                                                                                                              \
  {                                                                                                               \
    ACN_PDU_PACK_NORMAL_LEN(&bufptr[ACN_UDP_PREAMBLE_SIZE], SACN_UNIVERSE_DISCOVERY_HEADER_SIZE + (count * 2u) -  \
                                                                ACN_UDP_PREAMBLE_SIZE - SACN_RTP_HEADER_SIZE);    \
